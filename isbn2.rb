...
#   .gsub appears to be preferred method for substitions/removal of undesired characters
    new_isbn = isbn_num.gsub("-", "")
    new_isbn = new_isbn.gsub(" ", "")
    ...
    if isbn_check.count("^0-9").zero? && isbn_checksum.count("^0-9xX")
